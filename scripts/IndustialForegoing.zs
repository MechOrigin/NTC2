...
//craftingTable.removeRecipe(<item:industrialforegoing:tinydryrubber>);

//craftingTable.removeRecipe(<item:industrialforegoing:dryrubber>);

//craftingTable.removeRecipe(<item:industrialforegoing:plastic>);
...
// Progression changed for laser miner stuff
