...
mods.extendedcrafting.TableCrafting.addShaped("colossal_star_omega", 3, <item:projectexpansion:colossal_star_omega>, [
	...
	[<item:mekanismmatter:universal_matter>, <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:yellow_matter" as string}), <item:minecraft:air>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:yellow_matter" as string}), <item:extendedcrafting:ultimate_component>, <item:mekanismmatter:universal_matter>], 
	[<item:mekanismmatter:universal_matter>, <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:singularity>.withTag({Id: "extendedcrafting:yellow_matter" as string}), <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:ultimate_component>, <item:mekanismmatter:universal_matter>], 
	[<item:minecraft:air>, <item:mekanismmatter:universal_matter>, <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:ultimate_component>, <item:extendedcrafting:ultimate_component>, <item:mekanismmatter:universal_matter>, <item:minecraft:air>], 
	[<item:minecraft:air>, <item:minecraft:air>, <item:mekanismmatter:universal_matter>, <item:mekanismmatter:universal_matter>, <item:mekanismmatter:universal_matter>, <item:minecraft:air>, <item:minecraft:air>]
]);