...
<recipetype:thermal:centrifuge>.addRecipe("fading_collector", [<item:projectexpansion:white_collector>, <item:projectexpansion:fading_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:fading_collector>,20);
<recipetype:thermal:centrifuge>.addRecipe("white_collector", [<item:projectexpansion:orange_collector>, <item:projectexpansion:white_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:white_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("orange_collector", [<item:projectexpansion:yellow_collector>, <item:projectexpansion:orange_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:orange_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("yellow_collector", [<item:projectexpansion:lime_collector>, <item:projectexpansion:yellow_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:yellow_collector>, 20);
...
<recipetype:thermal:centrifuge>.addRecipe("green_collector", [<item:projectexpansion:cyan_collector>, <item:projectexpansion:green_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:green_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("cyan_collector", [<item:projectexpansion:blue_collector>, <item:projectexpansion:cyan_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:cyan_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("blue_collector", [<item:projectexpansion:violet_collector>, <item:projectexpansion:blue_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:blue_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("violet_collector", [<item:projectexpansion:purple_collector>, <item:projectexpansion:violet_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:violet_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("purple_collector", [<item:projectexpansion:pink_collector>, <item:projectexpansion:purple_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:purple_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("pink_collector", [<item:projectexpansion:magenta_collector>, <item:projectexpansion:pink_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:pink_collector>, 20);
<recipetype:thermal:centrifuge>.addRecipe("magenta_collector", [<item:projectexpansion:red_collector>, <item:projectexpansion:magenta_matter> * 16, <item:ae2extras:16m_cell_component> *8], <fluid:minecraft:empty>, <item:projectexpansion:magenta_collector>, 20);
