onEvent('recipes', (event) => {
    const recipes = [
        ...
        {
            output: Item.of('industrialforegoing:advanced_black_hole_tank', 1),
            pattern: ['PPP', 'NNN', 'CMC'],
            key: {
                P: '#forge:plastic',
                N: 'enderioalloys:item_alloy_ingot_crystalline_pink_slime',
                C: 'minecraft:bucket',
                M: '#industrialforegoing:machine_frame/advanced'
            },
            id: 'industrialforegoing:advanced_black_hole_tank_from_enderioalloys'
        },
        {
            output: Item.of('industrialforegoing:common_black_hole_tank', 1),
            pattern: ['PPP', 'CEC', 'CMC'],
            key: {
                P: '#forge:ingots/iron',
                E: '#forge:ingots/iron',
            ...
            id: 'industrialforegoing:common_black_hole_tank_from_enderioalloys'
        },
        {
            output: Item.of('industrialforegoing:pity_black_hole_tank', 1),
            pattern: ['PPP', 'NEN', 'CMC'],
            key: {
                P: '#forge:plastic',
            ...
            id: 'industrialforegoing:pity_black_hole_tank_from_enderioalloys'
        },
        {
            output: Item.of('industrialforegoing:simple_black_hole_tank', 1),
            pattern: ['PPP', 'NNN', 'CMC'],
            key: {
                P: '#forge:plastic',
                N: 'tconstruct:manyullyn_ingot',
                C: 'minecraft:bucket',
                M: '#industrialforegoing:machine_frame/simple'
            },
            id: 'industrialforegoing:simple_black_hole_tank_from_enderioalloys'
        },
        {
            output: Item.of('industrialforegoing:supreme_black_hole_tank', 1),
            pattern: ['PPP', 'NNN', 'CMC'],
            key: {
                P: '#forge:plastic',
                N: 'miniutilities:unstable_ingot',
                C: 'minecraft:bucket',
                M: '#industrialforegoing:machine_frame/supreme'
            },
            id: 'industrialforegoing:supreme_black_hole_tank_from_enderioalloys'
        }
    ];
