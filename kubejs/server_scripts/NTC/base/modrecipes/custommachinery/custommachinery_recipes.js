onEvent('recipes', event => {
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        ...
        .requireItem(Item.of("appliedenergistics2:smooth_sky_stone_block", 20), "input2")
        .requireItem(Item.of("appliedenergistics2:energy_acceptor", 6), "input3")
        .requireItem(Item.of("appliedenergistics2:quantum_ring", 54), "input4")
        .requireItem(Item.of("extendedcrafting:crystaltine_block", 44), "input5")
        ...
        // mek steel casing
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:steel_block", 38), "input1")
        .requireItem(Item.of("mekanismadditions:black_plastic", 60), "input2")
        .requireItem(Item.of("emendatusenigmatica:osmium_block", 27), "input3")
        ...
        // myst agri frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("mysticalagriculture:inferium_block", 4), "input1")
        .requireItem(Item.of("minecraft:iron_block", 56), "input2")
        .requireItem(Item.of("mysticalagriculture:prosperity_block", 4), "input3")
        ...
        // pity machine frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("quark:sturdy_stone", 24), "input1")
        .requireItem(Item.of("immersiveengineering:treated_wood_horizontal", 24), "input2")
        .requireItem(Item.of("minecraft:iron_block", 8), "input3")
        .requireItem(Item.of("extendedcrafting:redstone_ingot_block", 8), "input4")
        ...
        // rf tools frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("mekanismadditions:gray_plastic", 56), "input1")
        .requireItem(Item.of("emendatusenigmatica:cobalt_block", 4), "input2")
        .requireItem(Item.of("emendatusenigmatica:dimensional_block", 4), "input3")
        ...
        // thermal fluid frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:aluminum_block", 24), "input1")
        .requireItem(Item.of("emendatusenigmatica:copper_block", 8), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 24), "input3")
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:steel_block", 16), "input1")
        .requireItem(Item.of("minecraft:iron_block", 16), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 24), "input3")
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:electrum_block", 24), "input1")
        .requireItem(Item.of("emendatusenigmatica:lead_block", 8), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 24), "input3")
        ...
        // end resin processor
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("enderioalloys:block_alloy_crystalline_pink_slime", 8), "input1")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_maximum_port_fluids_input", 4), "input2")
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        ...
        .requireItem(Item.of("extendedcrafting:the_ultimate_block", 1), "input7") 
        .requireEnergy(5000)
