onEvent('recipes', event => {
    ...
    // end resin processor
    event.recipes.custommachinery.custom_machine("custommachinery:end_resin_processor", 100)
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:fluix_block", 1), "input1")
        .requireItem(Item.of("appliedenergistics2:smooth_sky_stone_block", 1), "input2")
        .requireItem(Item.of("appliedenergistics2:energy_acceptor", 1), "input3")
        .requireItem(Item.of("appliedenergistics2:quantum_ring", 1), "input4")
        .requireItem(Item.of("extendedcrafting:crystaltine_block", 1), "input5")
        .requireItem(Item.of("appliedenergistics2:quartz_vibrant_glass", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("appliedenergistics2:controller", 2), "output1")

        // mek steel casing
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:steel_block", 1), "input1")
        .requireItem(Item.of("mekanismadditions:black_plastic", 1), "input2")
        .requireItem(Item.of("emendatusenigmatica:osmium_block", 1), "input3")
        .requireItem(Item.of("extendedcrafting:ender_star", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("mekanism:steel_casing", 2), "output1")

        // myst agri frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("mysticalagriculture:inferium_block", 1), "input1")
        .requireItem(Item.of("minecraft:iron_block", 1), "input2")
        .requireItem(Item.of("mysticalagriculture:prosperity_block", 1), "input3")
        .requireItem(Item.of("mysticalagriculture:inferium_essence", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("mysticalagriculture:machine_frame", 2), "output1")

        // pity machine frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("quark:sturdy_stone", 1), "input1")
        .requireItem(Item.of("immersiveengineering:treated_wood_horizontal", 1), "input2")
        .requireItem(Item.of("minecraft:iron_block", 1), "input3")
        .requireItem(Item.of("extendedcrafting:redstone_ingot_block", 1), "input4")
        .requireItem(Item.of("industrialforegoing:plastic", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("industrialforegoing:machine_frame_pity", 2), "output1")

        // rf tools frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("mekanismadditions:gray_plastic", 1), "input1")
        .requireItem(Item.of("emendatusenigmatica:cobalt_block", 1), "input2")
        .requireItem(Item.of("emendatusenigmatica:dimensional_block", 1), "input3")
        .requireItem(Item.of("emendatusenigmatica:dimensional_gem", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("rftoolsbase:machine_frame", 2), "output1")

        // thermal fluid frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:aluminum_block", 1), "input1")
        .requireItem(Item.of("emendatusenigmatica:copper_block", 1), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 1), "input3")
        .requireItem(Item.of("emendatusenigmatica:bronze_gear", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("thermal:fluid_cell_frame", 2), "output1")
    ...
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        ...
        .requireItem(Item.of("minecraft:iron_block", 1), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 1), "input3")
        .requireItem(Item.of("tconstruct:clear_glass", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("thermal:machine_frame", 2), "output1")

        // thermal redstone frame
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("emendatusenigmatica:electrum_block", 1), "input1")
        .requireItem(Item.of("emendatusenigmatica:lead_block", 1), "input2")
        .requireItem(Item.of("tconstruct:clear_glass", 1), "input3")
        .requireItem(Item.of("emendatusenigmatica:electrum_gear", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of("thermal:energy_cell_frame", 2), "output1")

        // end resin processor
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("enderioalloys:block_alloy_crystalline_pink_slime", 1), "input1")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_maximum_port_fluids_input", 1), "input2")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_maximum_port_energy_input", 1), "input3")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_singlechest_port_items_input", 1), "input4")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_singlechest_port_items_output", 1), "input5")
        .requireItem(Item.of("masterfulmachinery:end_resin_processor_controller", 1), "input6")
        .requireItem(Item.of("avaritia:endest_pearl", 1), "input7")
        .requireEnergy(5000)
        .produceItem(Item.of('custommachinery:custom_machine_item', '{machine:"custommachinery:end_resin_processor"}', 1), "output1")

        // compact crafter
    event.recipes.custommachinery.custom_machine("custommachinery:compact_crafter", 100)
        .requireItem(Item.of("compactcrafting:field_projector", 1), "input1")
        .requireItem(Item.of("compactcrafting:match_proxy", 1), "input2")
        .requireItem(Item.of("ompactcrafting:rescan_proxy", 1), "input3")
        .requireItem(Item.of("rftoolsbuilder:space_chamber", 1), "input4")
        .requireItem(Item.of("rftoolsbuilder:space_chamber_controller", 1), "input5")
        .requireItem(Item.of("rftoolsbuilder:builder", 1), "input6")
        .requireItem(Item.of('extendedcrafting:singularity', '{Id:"enderioalloys:item_alloy_ingot_stellar_alloy"}', 1), "input7") 
        .requireEnergy(5000)
        .produceItem(Item.of('custommachinery:custom_machine_item', '{machine:"custommachinery:compact_crafter"}', 1), "output1")
})