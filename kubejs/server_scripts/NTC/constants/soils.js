...
const soilRegistry = [
    { block: 'minecraft:coarse_dirt', categories: ['dirt', 'coarse_dirt'], growthModifier: 0.05 },
    {
    ...
    { block: 'minecraft:netherrack', categories: ['nether', 'netherrack'], growthModifier: 0 },
    ...
    { block: 'minecraft:soul_soil', categories: ['soul_sand', 'nether', 'soul_soil'], growthModifier: 0 },
    { block: 'minecraft:basalt', categories: ['basalt', 'nether'], growthModifier: 0 },
    ...
    { block: 'inspirations:plain_mulch', categories: ['dirt'], growthModifier: 0.1 },
    { block: 'inspirations:brown_mulch', categories: ['dirt'], growthModifier: 0.2 },
    { block: 'inspirations:red_mulch', categories: ['dirt'], growthModifier: 0.3 },
    { block: 'inspirations:black_mulch', categories: ['dirt'], growthModifier: 0.4 },
    { block: 'inspirations:blue_mulch', categories: ['dirt'], growthModifier: 0.5 }
];
